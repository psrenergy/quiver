...
if(WIN32)
    set(DECK_DATABASE_PLATFORM "windows")
    set(DECK_DATABASE_LIB_PREFIX "")
    set(DECK_DATABASE_LIB_SUFFIX ".dll")
    set(DECK_DATABASE_STATIC_LIB_SUFFIX ".lib")
elseif(APPLE)
    set(DECK_DATABASE_PLATFORM "macos")
    set(DECK_DATABASE_LIB_PREFIX "lib")
    set(DECK_DATABASE_LIB_SUFFIX ".dylib")
    set(DECK_DATABASE_STATIC_LIB_SUFFIX ".a")
else()
    set(DECK_DATABASE_PLATFORM "linux")
    set(DECK_DATABASE_LIB_PREFIX "lib")
    set(DECK_DATABASE_LIB_SUFFIX ".so")
    set(DECK_DATABASE_STATIC_LIB_SUFFIX ".a")
endif()
