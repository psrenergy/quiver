...
- [ ] **Phase 1: C++ Core add_time_series_row** - Implement `Database::add_time_series_row` with upsert semantics, transaction-nest awareness, and full C++ test coverage
...
|-------|----------------|--------|-----------|
| 1. C++ Core add_time_series_row | 0/TBD | Not started | - |
