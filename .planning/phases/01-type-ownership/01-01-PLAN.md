...
<task type="auto">
  ...
  <action>
**src/c/database_options.h** -- Add `convert_database_options` inline function BEFORE the existing `convert_csv_options` function. Add at the top of the file body (after includes, before existing functions):
