...
MARGAUX_C_API psr_lua_runner_t* psr_lua_runner_new(psr_database_t* db);
...
MARGAUX_C_API margaux_error_t psr_lua_runner_run(psr_lua_runner_t* runner, const char* script);
...
MARGAUX_C_API const char* psr_lua_runner_get_error(psr_lua_runner_t* runner);
