...
class PsrDatabaseBindings {
  ...
  late final _margaux_create_elementPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int64 Function(ffi.Pointer<margaux_t>, ffi.Pointer<ffi.Char>,
              ffi.Pointer<margaux_element_t>)>>('margaux_create_element');
  late final _margaux_create_element = _margaux_create_elementPtr
      .asFunction<int Function(ffi.Pointer<margaux_t>, ffi.Pointer<ffi.Char>, ffi.Pointer<margaux_element_t>)>();
  ...
  late final _margaux_update_elementPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<margaux_t>, ffi.Pointer<ffi.Char>, ffi.Int64,
              ffi.Pointer<margaux_element_t>)>>('margaux_update_element');
  late final _margaux_update_element = _margaux_update_elementPtr
      .asFunction<int Function(ffi.Pointer<margaux_t>, ffi.Pointer<ffi.Char>, int, ffi.Pointer<margaux_element_t>)>();
  ...
  late final _margaux_element_create = _margaux_element_createPtr.asFunction<ffi.Pointer<margaux_element_t1> Function()>();
  ...
  late final _margaux_element_destroy = _margaux_element_destroyPtr.asFunction<void Function(ffi.Pointer<margaux_element_t1>)>();
  ...
  late final _margaux_element_clear = _margaux_element_clearPtr.asFunction<void Function(ffi.Pointer<margaux_element_t1>)>();
  ...
  late final _margaux_element_set_integerPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<margaux_element_t1>, ffi.Pointer<ffi.Char>, ffi.Int64)>>(
          'margaux_element_set_integer');
  late final _margaux_element_set_integer =
      _margaux_element_set_integerPtr.asFunction<int Function(ffi.Pointer<margaux_element_t1>, ffi.Pointer<ffi.Char>, int)>();
  ...
  late final _margaux_element_set_floatPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<margaux_element_t1>, ffi.Pointer<ffi.Char>, ffi.Double)>>(
          'margaux_element_set_float');
  late final _margaux_element_set_float =
      _margaux_element_set_floatPtr.asFunction<int Function(ffi.Pointer<margaux_element_t1>, ffi.Pointer<ffi.Char>, double)>();
  ...
  late final _margaux_element_set_stringPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<margaux_element_t1>, ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>>('margaux_element_set_string');
  ...
  late final _margaux_element_to_stringPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<margaux_element_t1>)>>('margaux_element_to_string');
  ...
  ffi.Pointer<margaux_lua_runner_t> margaux_lua_runner_new(
    ffi.Pointer<margaux_t> db,
  ) {
    return _margaux_lua_runner_new(
      db,
    );
  }

  late final _margaux_lua_runner_newPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<margaux_lua_runner_t> Function(ffi.Pointer<margaux_t>)>>(
          'margaux_lua_runner_new');
  late final _margaux_lua_runner_new =
      _margaux_lua_runner_newPtr.asFunction<ffi.Pointer<margaux_lua_runner_t> Function(ffi.Pointer<margaux_t>)>();

  void margaux_lua_runner_free(
    ffi.Pointer<margaux_lua_runner_t> runner,
  ) {
    return _margaux_lua_runner_free(
      runner,
    );
  }

  late final _margaux_lua_runner_freePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<margaux_lua_runner_t>)>>('margaux_lua_runner_free');
  late final _margaux_lua_runner_free = _margaux_lua_runner_freePtr.asFunction<void Function(ffi.Pointer<margaux_lua_runner_t>)>();

  int margaux_lua_runner_run(
    ffi.Pointer<margaux_lua_runner_t> runner,
    ffi.Pointer<ffi.Char> script,
  ) {
    return _margaux_lua_runner_run(
      runner,
      script,
    );
  }

  late final _margaux_lua_runner_runPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<margaux_lua_runner_t>, ffi.Pointer<ffi.Char>)>>(
          'margaux_lua_runner_run');
  late final _margaux_lua_runner_run =
      _margaux_lua_runner_runPtr.asFunction<int Function(ffi.Pointer<margaux_lua_runner_t>, ffi.Pointer<ffi.Char>)>();

  ffi.Pointer<ffi.Char> margaux_lua_runner_get_error(
    ffi.Pointer<margaux_lua_runner_t> runner,
  ) {
    return _margaux_lua_runner_get_error(
      runner,
    );
  }

  late final _margaux_lua_runner_get_errorPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<margaux_lua_runner_t>)>>(
          'margaux_lua_runner_get_error');
  late final _margaux_lua_runner_get_error =
      _margaux_lua_runner_get_errorPtr.asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<margaux_lua_runner_t>)>();
}
...
final class margaux_lua_runner extends ffi.Opaque {}

typedef margaux_lua_runner_t = margaux_lua_runner;
