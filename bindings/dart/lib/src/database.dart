  ...
  ({String dataStructure, String dataType}) getAttributeType(String collection, String attribute) {
    ...
    try {
      ...
      final dataStructure = switch (outDataStructure.value) {
        margaux_data_structure_t.DECK_DATABASE_DATA_STRUCTURE_SCALAR => 'scalar',
        margaux_data_structure_t.DECK_DATABASE_DATA_STRUCTURE_VECTOR => 'vector',
        margaux_data_structure_t.DECK_DATABASE_DATA_STRUCTURE_SET => 'set',
        _ => 'unknown',
      };

      final dataType = switch (outDataType.value) {
        margaux_data_type_t.DECK_DATABASE_DATA_TYPE_INTEGER => 'integer',
        margaux_data_type_t.DECK_DATABASE_DATA_TYPE_FLOAT => 'real',
        margaux_data_type_t.DECK_DATABASE_DATA_TYPE_STRING => 'text',
        _ => 'unknown',
      };
