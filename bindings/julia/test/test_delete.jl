...
@testset "Delete" begin
    @testset "Element By ID" begin
        ...
        QUIVERDatabase.create_element!(db, "Configuration"; label = "Config 3")
        ...
        QUIVERDatabase.delete_element_by_id!(db, "Configuration", Int64(2))
    ...
    @testset "Element With Vector Data (CASCADE)" begin
        ...
        QUIVERDatabase.delete_element_by_id!(db, "Collection", Int64(1))
        ...
        values = QUIVERDatabase.read_vector_integers(db, "Collection", "value_int")
    ...
    @testset "Element With Set Data (CASCADE)" begin
        ...
        QUIVERDatabase.create_element!(db, "Collection"; label = "Item 1", tag = ["alpha", "beta"])
        QUIVERDatabase.create_element!(db, "Collection"; label = "Item 2", tag = ["gamma", "delta"])
        ...
        sets = QUIVERDatabase.read_set_strings(db, "Collection", "tag")
        @test length(sets) == 1
    ...
    @testset "Non-Existent Element (Idempotent)" begin
        ...
        QUIVERDatabase.delete_element_by_id!(db, "Configuration", Int64(999))
    ...
    @testset "Does Not Affect Other Elements" begin
        ...
        values = QUIVERDatabase.read_scalar_integers(db, "Configuration", "integer_attribute")
