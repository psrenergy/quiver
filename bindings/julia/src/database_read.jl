function read_scalar_relation(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_read_scalar_relation(db.ptr, collection, attribute, out_values, out_count)
    if err != C.MARGAUX_OK
...
function read_scalar_integers(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_read_scalar_integers(db.ptr, collection, attribute, out_values, out_count)
    if err != C.MARGAUX_OK
...
function read_scalar_floats(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_read_scalar_floats(db.ptr, collection, attribute, out_values, out_count)
    if err != C.MARGAUX_OK
...
function read_scalar_strings(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_read_scalar_strings(db.ptr, collection, attribute, out_values, out_count)
    if err != C.MARGAUX_OK
...
function read_vector_integers(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_read_vector_integers(db.ptr, collection, attribute, out_vectors, out_sizes, out_count)
    if err != C.MARGAUX_OK
...
function read_vector_floats(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_read_vector_floats(db.ptr, collection, attribute, out_vectors, out_sizes, out_count)
    if err != C.MARGAUX_OK
...
function read_vector_strings(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_read_vector_strings(db.ptr, collection, attribute, out_vectors, out_sizes, out_count)
    if err != C.MARGAUX_OK
...
function read_set_integers(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_read_set_integers(db.ptr, collection, attribute, out_sets, out_sizes, out_count)
    if err != C.MARGAUX_OK
...
function read_set_floats(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_read_set_floats(db.ptr, collection, attribute, out_sets, out_sizes, out_count)
    if err != C.MARGAUX_OK
...
function read_set_strings(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_read_set_strings(db.ptr, collection, attribute, out_sets, out_sizes, out_count)
    if err != C.MARGAUX_OK
...
function read_scalar_integers_by_id(db::Database, collection::String, attribute::String, id::Int64)
    ...
    err = C.margaux_read_scalar_integers_by_id(db.ptr, collection, attribute, id, out_value, out_has_value)
    if err != C.MARGAUX_OK
...
function read_scalar_floats_by_id(db::Database, collection::String, attribute::String, id::Int64)
    ...
    err = C.margaux_read_scalar_floats_by_id(db.ptr, collection, attribute, id, out_value, out_has_value)
    if err != C.MARGAUX_OK
...
function read_scalar_strings_by_id(db::Database, collection::String, attribute::String, id::Int64)
    ...
    err = C.margaux_read_scalar_strings_by_id(db.ptr, collection, attribute, id, out_value, out_has_value)
    if err != C.MARGAUX_OK
...
function read_vector_integers_by_id(db::Database, collection::String, attribute::String, id::Int64)
    ...
    err = C.margaux_read_vector_integers_by_id(db.ptr, collection, attribute, id, out_values, out_count)
    if err != C.MARGAUX_OK
...
function read_vector_floats_by_id(db::Database, collection::String, attribute::String, id::Int64)
    ...
    err = C.margaux_read_vector_floats_by_id(db.ptr, collection, attribute, id, out_values, out_count)
    if err != C.MARGAUX_OK
...
function read_vector_strings_by_id(db::Database, collection::String, attribute::String, id::Int64)
    ...
    err = C.margaux_read_vector_strings_by_id(db.ptr, collection, attribute, id, out_values, out_count)
    if err != C.MARGAUX_OK
...
function read_set_integers_by_id(db::Database, collection::String, attribute::String, id::Int64)
    ...
    err = C.margaux_read_set_integers_by_id(db.ptr, collection, attribute, id, out_values, out_count)
    if err != C.MARGAUX_OK
...
function read_set_floats_by_id(db::Database, collection::String, attribute::String, id::Int64)
    ...
    err = C.margaux_read_set_floats_by_id(db.ptr, collection, attribute, id, out_values, out_count)
    if err != C.MARGAUX_OK
...
function read_set_strings_by_id(db::Database, collection::String, attribute::String, id::Int64)
    ...
    err = C.margaux_read_set_strings_by_id(db.ptr, collection, attribute, id, out_values, out_count)
    if err != C.MARGAUX_OK
...
function read_element_ids(db::Database, collection::String)
    ...
    err = C.margaux_read_element_ids(db.ptr, collection, out_ids, out_count)
    if err != C.MARGAUX_OK
...
function get_attribute_type(db::Database, collection::String, attribute::String)
    ...
    err = C.margaux_get_attribute_type(db.ptr, collection, attribute, out_data_structure, out_data_type)
    if err != C.MARGAUX_OK
