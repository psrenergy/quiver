...
@cenum psr_margaux_t::Int32 begin
    MARGAUX_OK = 0
...
function psr_error_string(error)
    @ccall libpsr_database_c.psr_error_string(error::psr_margaux_t)::Ptr{Cchar}
end
...
function psr_database_update_element(db, collection, id, element)
    @ccall libpsr_database_c.psr_database_update_element(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, id::Int64, element::Ptr{psr_element_t})::psr_margaux_t
end

function psr_database_delete_element_by_id(db, collection, id)
    @ccall libpsr_database_c.psr_database_delete_element_by_id(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, id::Int64)::psr_margaux_t
end

function psr_database_set_scalar_relation(db, collection, attribute, from_label, to_label)
    @ccall libpsr_database_c.psr_database_set_scalar_relation(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, from_label::Ptr{Cchar}, to_label::Ptr{Cchar})::psr_margaux_t
end

function psr_database_read_scalar_relation(db, collection, attribute, out_values, out_count)
    @ccall libpsr_database_c.psr_database_read_scalar_relation(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_values::Ptr{Ptr{Ptr{Cchar}}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_scalar_integers(db, collection, attribute, out_values, out_count)
    @ccall libpsr_database_c.psr_database_read_scalar_integers(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_values::Ptr{Ptr{Int64}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_scalar_floats(db, collection, attribute, out_values, out_count)
    @ccall libpsr_database_c.psr_database_read_scalar_floats(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_values::Ptr{Ptr{Cdouble}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_scalar_strings(db, collection, attribute, out_values, out_count)
    @ccall libpsr_database_c.psr_database_read_scalar_strings(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_values::Ptr{Ptr{Ptr{Cchar}}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_vector_integers(db, collection, attribute, out_vectors, out_sizes, out_count)
    @ccall libpsr_database_c.psr_database_read_vector_integers(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_vectors::Ptr{Ptr{Ptr{Int64}}}, out_sizes::Ptr{Ptr{Csize_t}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_vector_floats(db, collection, attribute, out_vectors, out_sizes, out_count)
    @ccall libpsr_database_c.psr_database_read_vector_floats(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_vectors::Ptr{Ptr{Ptr{Cdouble}}}, out_sizes::Ptr{Ptr{Csize_t}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_vector_strings(db, collection, attribute, out_vectors, out_sizes, out_count)
    @ccall libpsr_database_c.psr_database_read_vector_strings(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_vectors::Ptr{Ptr{Ptr{Ptr{Cchar}}}}, out_sizes::Ptr{Ptr{Csize_t}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_set_integers(db, collection, attribute, out_sets, out_sizes, out_count)
    @ccall libpsr_database_c.psr_database_read_set_integers(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_sets::Ptr{Ptr{Ptr{Int64}}}, out_sizes::Ptr{Ptr{Csize_t}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_set_floats(db, collection, attribute, out_sets, out_sizes, out_count)
    @ccall libpsr_database_c.psr_database_read_set_floats(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_sets::Ptr{Ptr{Ptr{Cdouble}}}, out_sizes::Ptr{Ptr{Csize_t}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_set_strings(db, collection, attribute, out_sets, out_sizes, out_count)
    @ccall libpsr_database_c.psr_database_read_set_strings(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_sets::Ptr{Ptr{Ptr{Ptr{Cchar}}}}, out_sizes::Ptr{Ptr{Csize_t}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_scalar_integers_by_id(db, collection, attribute, id, out_value, out_has_value)
    @ccall libpsr_database_c.psr_database_read_scalar_integers_by_id(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, out_value::Ptr{Int64}, out_has_value::Ptr{Cint})::psr_margaux_t
end

function psr_database_read_scalar_floats_by_id(db, collection, attribute, id, out_value, out_has_value)
    @ccall libpsr_database_c.psr_database_read_scalar_floats_by_id(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, out_value::Ptr{Cdouble}, out_has_value::Ptr{Cint})::psr_margaux_t
end

function psr_database_read_scalar_strings_by_id(db, collection, attribute, id, out_value, out_has_value)
    @ccall libpsr_database_c.psr_database_read_scalar_strings_by_id(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, out_value::Ptr{Ptr{Cchar}}, out_has_value::Ptr{Cint})::psr_margaux_t
end

function psr_database_read_vector_integers_by_id(db, collection, attribute, id, out_values, out_count)
    @ccall libpsr_database_c.psr_database_read_vector_integers_by_id(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, out_values::Ptr{Ptr{Int64}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_vector_floats_by_id(db, collection, attribute, id, out_values, out_count)
    @ccall libpsr_database_c.psr_database_read_vector_floats_by_id(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, out_values::Ptr{Ptr{Cdouble}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_vector_strings_by_id(db, collection, attribute, id, out_values, out_count)
    @ccall libpsr_database_c.psr_database_read_vector_strings_by_id(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, out_values::Ptr{Ptr{Ptr{Cchar}}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_set_integers_by_id(db, collection, attribute, id, out_values, out_count)
    @ccall libpsr_database_c.psr_database_read_set_integers_by_id(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, out_values::Ptr{Ptr{Int64}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_set_floats_by_id(db, collection, attribute, id, out_values, out_count)
    @ccall libpsr_database_c.psr_database_read_set_floats_by_id(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, out_values::Ptr{Ptr{Cdouble}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_set_strings_by_id(db, collection, attribute, id, out_values, out_count)
    @ccall libpsr_database_c.psr_database_read_set_strings_by_id(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, out_values::Ptr{Ptr{Ptr{Cchar}}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_read_element_ids(db, collection, out_ids, out_count)
    @ccall libpsr_database_c.psr_database_read_element_ids(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, out_ids::Ptr{Ptr{Int64}}, out_count::Ptr{Csize_t})::psr_margaux_t
end

function psr_database_get_attribute_type(db, collection, attribute, out_data_structure, out_data_type)
    @ccall libpsr_database_c.psr_database_get_attribute_type(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, out_data_structure::Ptr{psr_data_structure_t}, out_data_type::Ptr{psr_data_type_t})::psr_margaux_t
end

function psr_database_update_scalar_integer(db, collection, attribute, id, value)
    @ccall libpsr_database_c.psr_database_update_scalar_integer(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, value::Int64)::psr_margaux_t
end

function psr_database_update_scalar_float(db, collection, attribute, id, value)
    @ccall libpsr_database_c.psr_database_update_scalar_float(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, value::Cdouble)::psr_margaux_t
end

function psr_database_update_scalar_string(db, collection, attribute, id, value)
    @ccall libpsr_database_c.psr_database_update_scalar_string(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, value::Ptr{Cchar})::psr_margaux_t
end

function psr_database_update_vector_integers(db, collection, attribute, id, values, count)
    @ccall libpsr_database_c.psr_database_update_vector_integers(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, values::Ptr{Int64}, count::Csize_t)::psr_margaux_t
end

function psr_database_update_vector_floats(db, collection, attribute, id, values, count)
    @ccall libpsr_database_c.psr_database_update_vector_floats(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, values::Ptr{Cdouble}, count::Csize_t)::psr_margaux_t
end

function psr_database_update_vector_strings(db, collection, attribute, id, values, count)
    @ccall libpsr_database_c.psr_database_update_vector_strings(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, values::Ptr{Ptr{Cchar}}, count::Csize_t)::psr_margaux_t
end

function psr_database_update_set_integers(db, collection, attribute, id, values, count)
    @ccall libpsr_database_c.psr_database_update_set_integers(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, values::Ptr{Int64}, count::Csize_t)::psr_margaux_t
end

function psr_database_update_set_floats(db, collection, attribute, id, values, count)
    @ccall libpsr_database_c.psr_database_update_set_floats(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, values::Ptr{Cdouble}, count::Csize_t)::psr_margaux_t
end

function psr_database_update_set_strings(db, collection, attribute, id, values, count)
    @ccall libpsr_database_c.psr_database_update_set_strings(db::Ptr{psr_database_t}, collection::Ptr{Cchar}, attribute::Ptr{Cchar}, id::Int64, values::Ptr{Ptr{Cchar}}, count::Csize_t)::psr_margaux_t
end
...
function psr_element_set_integer(element, name, value)
    @ccall libpsr_database_c.psr_element_set_integer(element::Ptr{psr_element_t}, name::Ptr{Cchar}, value::Int64)::psr_margaux_t
end

function psr_element_set_float(element, name, value)
    @ccall libpsr_database_c.psr_element_set_float(element::Ptr{psr_element_t}, name::Ptr{Cchar}, value::Cdouble)::psr_margaux_t
end

function psr_element_set_string(element, name, value)
    @ccall libpsr_database_c.psr_element_set_string(element::Ptr{psr_element_t}, name::Ptr{Cchar}, value::Ptr{Cchar})::psr_margaux_t
end

function psr_element_set_null(element, name)
    @ccall libpsr_database_c.psr_element_set_null(element::Ptr{psr_element_t}, name::Ptr{Cchar})::psr_margaux_t
end

function psr_element_set_array_integer(element, name, values, count)
    @ccall libpsr_database_c.psr_element_set_array_integer(element::Ptr{psr_element_t}, name::Ptr{Cchar}, values::Ptr{Int64}, count::Int32)::psr_margaux_t
end

function psr_element_set_array_float(element, name, values, count)
    @ccall libpsr_database_c.psr_element_set_array_float(element::Ptr{psr_element_t}, name::Ptr{Cchar}, values::Ptr{Cdouble}, count::Int32)::psr_margaux_t
end

function psr_element_set_array_string(element, name, values, count)
    @ccall libpsr_database_c.psr_element_set_array_string(element::Ptr{psr_element_t}, name::Ptr{Cchar}, values::Ptr{Ptr{Cchar}}, count::Int32)::psr_margaux_t
end
...
function psr_lua_runner_run(runner, script)
    @ccall libpsr_database_c.psr_lua_runner_run(runner::Ptr{psr_lua_runner_t}, script::Ptr{Cchar})::psr_margaux_t
end
