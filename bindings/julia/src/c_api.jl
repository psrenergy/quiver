...
function quiver_database_read_element_count(db, collection, out_count)
    @ccall libquiver_c.quiver_database_read_element_count(db::Ptr{quiver_database_t}, collection::Ptr{Cchar}, out_count::Ptr{Int64})::quiver_error_t
end
