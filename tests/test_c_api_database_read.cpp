...
TEST(DatabaseCApi, ReadScalarIntegerById) {
    ...
    int has_value;
    auto err =
        quiver_database_read_scalar_integers_by_id(db, "Configuration", "integer_attribute", id1, &value, &has_value);
...
TEST(DatabaseCApi, ReadScalarByIdNotFound) {
    ...
    int has_value;
    auto err =
        quiver_database_read_scalar_integers_by_id(db, "Configuration", "integer_attribute", 999, &value, &has_value);
...
TEST(DatabaseCApi, GetAttributeTypeScalarInteger) {
    ...
    EXPECT_EQ(data_type, QUIVER_DATA_TYPE_INTEGER);
...
TEST(DatabaseCApi, GetAttributeTypeScalarReal) {
    ...
    quiver_data_structure_t data_structure;
    quiver_data_type_t data_type;
    auto err = quiver_database_get_attribute_type(db, "Configuration", "float_attribute", &data_structure, &data_type);

    EXPECT_EQ(err, QUIVER_OK);
    EXPECT_EQ(data_structure, QUIVER_DATA_STRUCTURE_SCALAR);
    EXPECT_EQ(data_type, QUIVER_DATA_TYPE_FLOAT);
...
TEST(DatabaseCApi, GetAttributeTypeScalarText) {
    ...
    quiver_data_structure_t data_structure;
    quiver_data_type_t data_type;
    auto err = quiver_database_get_attribute_type(db, "Configuration", "string_attribute", &data_structure, &data_type);

    EXPECT_EQ(err, QUIVER_OK);
    EXPECT_EQ(data_structure, QUIVER_DATA_STRUCTURE_SCALAR);
    EXPECT_EQ(data_type, QUIVER_DATA_TYPE_STRING);
...
TEST(DatabaseCApi, GetAttributeTypeVectorInteger) {
    ...
    quiver_data_structure_t data_structure;
    quiver_data_type_t data_type;
    auto err = quiver_database_get_attribute_type(db, "Collection", "value_int", &data_structure, &data_type);

    EXPECT_EQ(err, QUIVER_OK);
    EXPECT_EQ(data_structure, QUIVER_DATA_STRUCTURE_VECTOR);
    EXPECT_EQ(data_type, QUIVER_DATA_TYPE_INTEGER);
...
TEST(DatabaseCApi, GetAttributeTypeVectorReal) {
    ...
    quiver_data_structure_t data_structure;
    quiver_data_type_t data_type;
    auto err = quiver_database_get_attribute_type(db, "Collection", "value_float", &data_structure, &data_type);
...
TEST(DatabaseCApi, GetAttributeTypeSetText) {
    ...
    quiver_data_structure_t data_structure;
    quiver_data_type_t data_type;
    auto err = quiver_database_get_attribute_type(db, "Collection", "tag", &data_structure, &data_type);

    EXPECT_EQ(err, QUIVER_OK);
    EXPECT_EQ(data_structure, QUIVER_DATA_STRUCTURE_SET);
    EXPECT_EQ(data_type, QUIVER_DATA_TYPE_STRING);
...
TEST(DatabaseCApi, GetAttributeTypeNotFound) {
    ...
    quiver_data_structure_t data_structure;
    quiver_data_type_t data_type;
    auto err = quiver_database_get_attribute_type(db, "Configuration", "nonexistent", &data_structure, &data_type);
...
TEST(DatabaseCApi, GetAttributeTypeInvalidArgument) {
    ...
    // Null db
    auto err = quiver_database_get_attribute_type(nullptr, "Configuration", "label", &data_structure, &data_type);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);

    // Null collection
    err = quiver_database_get_attribute_type(db, nullptr, "label", &data_structure, &data_type);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);

    // Null attribute
    err = quiver_database_get_attribute_type(db, "Configuration", nullptr, &data_structure, &data_type);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);

    // Null out_data_structure
    err = quiver_database_get_attribute_type(db, "Configuration", "label", nullptr, &data_type);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);

    // Null out_data_type
    err = quiver_database_get_attribute_type(db, "Configuration", "label", &data_structure, nullptr);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);
...
TEST(DatabaseCApi, ReadScalarIntegersByIdNullCollection) {
    ...
    int64_t value;
    int has_value;
    auto err = quiver_database_read_scalar_integers_by_id(db, nullptr, "integer_attribute", 1, &value, &has_value);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);
...
TEST(DatabaseCApi, ReadScalarIntegersByIdNullOutput) {
    ...
    int has_value;
    auto err =
        quiver_database_read_scalar_integers_by_id(db, "Configuration", "integer_attribute", 1, nullptr, &has_value);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);

    int64_t value;
    err = quiver_database_read_scalar_integers_by_id(db, "Configuration", "integer_attribute", 1, &value, nullptr);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);
...
TEST(DatabaseCApi, ReadScalarFloatsByIdNullDb) {
    ...
    int has_value;
    auto err =
        quiver_database_read_scalar_floats_by_id(nullptr, "Configuration", "float_attribute", 1, &value, &has_value);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);
}
...
TEST(DatabaseCApi, ReadScalarFloatsByIdNullOutput) {
    ...
    int has_value;
    auto err = quiver_database_read_scalar_floats_by_id(db, "Configuration", "float_attribute", 1, nullptr, &has_value);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);

    double value;
    err = quiver_database_read_scalar_floats_by_id(db, "Configuration", "float_attribute", 1, &value, nullptr);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);
...
TEST(DatabaseCApi, ReadScalarStringsByIdNullDb) {
    ...
    int has_value;
    auto err =
        quiver_database_read_scalar_strings_by_id(nullptr, "Configuration", "string_attribute", 1, &value, &has_value);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);
}
...
TEST(DatabaseCApi, ReadScalarStringsByIdNullOutput) {
    ...
    char* value = nullptr;
    err = quiver_database_read_scalar_strings_by_id(db, "Configuration", "string_attribute", 1, &value, nullptr);
    EXPECT_EQ(err, QUIVER_ERROR_INVALID_ARGUMENT);
